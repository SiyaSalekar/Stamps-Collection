function categoryid_validation(){
    ...
    document.getElementById('uid_err').style.fontSize = "14px";
    return false;
    }
...
function price_validation(){
    ...
    document.getElementById('pr_err').style.fontSize = "14px";
        return false;
    }
...
function year_validation(){
    ...
    document.getElementById('yr_err').style.fontSize = "14px";
    return false;
    }
    else if(!/^[0-9]+$/.test(userid_length)){
...
function size_validation(){
    ...
    document.getElementById('sr_err').style.fontSize = "14px";
    return false;
    }
    else
    {
